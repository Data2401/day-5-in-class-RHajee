...
my_name   # r does not need print functions to display outputs
area
too_big
...
round_sum
sum_round
print('There is a 0.1 difference between round_sum and sum_round with round_sum being the larger value.')